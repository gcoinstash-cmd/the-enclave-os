      ...
      <header className="sticky top-0 z-40 bg-[#050505]/95 backdrop-blur-md border-b border-neutral-950 px-4 sm:px-6 lg:px-12 py-5 transition-all">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3 sm:gap-4 shrink-0">
            ...
            <button
              onClick={() => setIsAdminPassOpen(true)}
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 sm:px-3.5 sm:py-2 bg-[#14120F] hover:bg-[#201C15] border border-gold-500/30 hover:border-gold-500/60 rounded-md text-[10px] font-mono uppercase tracking-[0.2em] text-[#E5D3B3] transition-all duration-300 cursor-pointer shadow-[0_0_15px_rgba(176,158,81,0.15)]"
            ...
            <button
              ...
              className="px-3.5 py-1.5 sm:px-4 sm:py-2 bg-transparent hover:bg-white/[0.02] border border-white/10 hover:border-gold-500/25 rounded-md text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-400 hover:text-[#E5D3B3] transition-all duration-300 cursor-pointer"
            ...
            >
              ...
              <div className="p-3 bg-neutral-950/80 border border-gold-500/20 rounded-lg">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-mono uppercase tracking-wider text-neutral-400">Demo Passcode:</span>
                ...
                <button
                  ...
                  className="mt-2.5 w-full py-2 bg-gold-500/10 hover:bg-gold-500/20 border border-gold-500/30 hover:border-gold-500/50 rounded text-[10px] font-mono uppercase tracking-widest text-[#E5D3B3] transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
              ...
              >
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    type="submit"
                    className="flex-1 py-3 px-4 bg-[#B09E51] hover:bg-[#C1B369] text-black font-semibold text-xs font-mono uppercase tracking-widest rounded-md transition-all shadow-lg shadow-gold-500/20"
                  >
                    Unlock Board
                  </button>
                </div>
